...
const SpecimenSelectorModal: React.FC<SpecimenSelectorModalProps> = ({ 
  ...
  if (!order || !order.specimens?.specimenList) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 w-11/12 max-w-3xl max-h-[90vh] overflow-auto">
          ...
          <div className="text-center py-8 text-gray-500">
            No specimens available in this message
          </div>
  ...
  console.log("SpecimenSelectorModal - Specimens available:", order.specimens?.specimenList?.length);

...
interface SlideSelectorModalProps {
  isOpen: boolean;
  onClose: () => void;
  message: any;
...
const SlideSelectorModal: React.FC<SlideSelectorModalProps> = ({
  isOpen,
  onClose,
  message,
  onSelectSlide
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-11/12 max-w-3xl max-h-[90vh] overflow-auto">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold">Select a Slide</h2>
...
export default SlideSelectorModal;
